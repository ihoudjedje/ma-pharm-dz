...
public class ListeMedGastro_Enterologie extends Fragment implements SwipeRefreshLayout.OnRefreshListener, RecyclerItemClickListener.OnItemClickListener {
    RecyclerView myList;
    public static Context C;
    private SwipeRefreshLayout swipeContainer;
    private SwipeRefreshLayout EmptyswipeContainer;
    private String Url = "http://192.168.43.168/android_login_maphdz/gestion_medicaments/medicament_Gastro_Enterologie.php";
    static Exception exceptionToBeThrown;
    static AdpListeMed adapter;
    static List<Medicament> listMedicament = new ArrayList<>();
    //public String type = "Gastro-Enterologie";
