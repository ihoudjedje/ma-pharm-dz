 ...
 */
public class ListeMedAntiInflam extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    private RecyclerView myList;
    public static Context C ;
    private SwipeRefreshLayout swipeContainer;
    private SwipeRefreshLayout EmptyswipeContainer;
    public static String Url = "http://192.168.43.168/android_login_maphdz/gestion_medicaments/medicament_Anti_inflammatoires.php";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      //  IdActualPharmacy = sp.getString("unique_id_phar", null);//context of the contxt where you have set the sharedValue
        ...
        Log.i("Test","here is the id of the actual pharmacy before passing it to url 'ListeMedAntiInflam': "+IdActualPharmacy);
